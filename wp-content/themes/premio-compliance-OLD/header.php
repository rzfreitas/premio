		...
		<div class="row menu-top">
			<div class="col-9 col-md-3">
				<div class="site-branding">					
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/compliance-brasil.png" alt="prêmio compliance Brasil 2017" /></a>					
				</div><!-- .site-branding -->
			</div>
